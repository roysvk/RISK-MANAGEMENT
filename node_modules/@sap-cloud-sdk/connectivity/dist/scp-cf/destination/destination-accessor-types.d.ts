 ...
 */
export declare type DestinationWithoutToken = Omit<Destination, 'authTokens'>;
/**
 * Options used to fetch all destinations.
 */
export declare type AllDestinationOptions = Omit<DestinationOptions, 'selectionStrategy' | 'isolationStrategy'>;
